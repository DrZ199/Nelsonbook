...
This script creates the nelson_pediatrics_clean table in Supabase using the Supabase client.
"""
...
def create_table():
    ...
    try:
        ...
        print("Please create the table manually using the Supabase dashboard SQL editor with the following SQL:")
        print("""
