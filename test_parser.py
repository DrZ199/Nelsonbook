#!/usr/bin/env python3
"""
Test version of the Improved Structured Parser for Nelson Textbook of Pediatrics
...
class TestParser:
    def __init__(self, output_dir="structured_output"):
        ...
        # Common drug names in pediatrics (shortened list for testing)
        self.common_drugs = [
            "acetaminophen", "ibuprofen", "amoxicillin", "albuterol", 
            "prednisolone", "prednisone", "methylphenidate", "loratadine", 
            "diphenhydramine", "ondansetron", "azithromycin", 
            "penicillin", "ampicillin", "gentamicin", "vancomycin",
            "dexamethasone", "montelukast", 
            "morphine", "fentanyl", "oxycodone", 
            "midazolam", "lorazepam", "diazepam",
            "phenobarbital", "carbamazepine", "valproic acid", 
            "insulin", "metformin", "levothyroxine", "hydrocortisone",
        ...
        # Common medical conditions in pediatrics (shortened list for testing)
        self.common_conditions = [
            "asthma", "pneumonia", "bronchiolitis", "croup", "otitis media",
            "pharyngitis", "tonsillitis", "urinary tract infection",
            "gastroenteritis", "appendicitis", "constipation",
            "eczema", "impetigo", "cellulitis", 
            "meningitis", "encephalitis", "febrile seizure", "epilepsy", "cerebral palsy",
            "attention deficit hyperactivity disorder", "autism spectrum disorder", "depression", "anxiety",
            "type 1 diabetes", "hypothyroidism", "hyperthyroidism", 
            "sickle cell disease", "iron deficiency anemia", "leukemia",
            "congenital heart disease", "ventricular septal defect", "atrial septal defect",
            "kawasaki disease", "rheumatic fever", "juvenile idiopathic arthritis",
            "nephrotic syndrome", "glomerulonephritis", 
            "cleft lip", "cleft palate", "pyloric stenosis", 
            "down syndrome", "turner syndrome", "fragile x syndrome",
            "cystic fibrosis", "duchenne muscular dystrophy", 
            "rickets", "failure to thrive", "obesity", "malnutrition",
